...
difftests_json = """{
    ...
    "linecount": {
    "timeout 2 ./word-count/linecount.bin ./word-count/txt/input.txt > ./word-count/out/input.txt.linecount; python3 compare.py  ./word-count/out/input.txt.linecount ./word-count/reference/input.txt.linecount": 20
    },
    "subtract": {
    "timeout 2 ./word-count/duplicate.bin ./word-count/txt/input.txt ./word-count/txt/small.txt > ./word-count/out/input.txt.subtract; python3 compare.py ./word-count/out/input.txt.subtract ./word-count/reference/input.txt.subtract": 40
    }
